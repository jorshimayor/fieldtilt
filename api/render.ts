...
const DEMO: Record<CardKind, unknown> = {
  ...
  match_stats: {
    ...
    rows: [
      ...
      { label: "Possession", home: "66%", away: "34%" },
      { label: "Shots", home: 19, away: 6 },
      ...
      { label: "Fouls", home: 7, away: 14 },
    ],
    footnote: "source: Sofascore · illustrative demo data",
  },
  scatter: {
    title: "The league map",
    context: "Premier League 25/26 · attack vs defence, per 90",
    xLabel: "xG created per 90",
    yLabel: "xG conceded per 90",
    yInvert: true,
    quadrants: { tl: "Blunt but solid", tr: "Title material", bl: "In trouble", br: "Chaos merchants" },
    points: [
      { label: "Chelsea", x: 1.92, y: 0.98, score: 0.9, highlight: true },
      { label: "Arsenal", x: 1.85, y: 1.02, score: 0.85 },
      { label: "Man City", x: 2.05, y: 1.25, score: 0.78 },
      { label: "Liverpool", x: 1.98, y: 1.18, score: 0.8 },
      { label: "Tottenham", x: 1.62, y: 1.35, score: 0.6 },
      { label: "Newcastle", x: 1.55, y: 1.2, score: 0.62 },
      { label: "Aston Villa", x: 1.48, y: 1.3, score: 0.55 },
      { label: "Brighton", x: 1.5, y: 1.5, score: 0.48 },
      { label: "Brentford", x: 1.32, y: 1.45, score: 0.42 },
      { label: "Everton", x: 1.05, y: 1.25, score: 0.45 },
      { label: "Fulham", x: 1.2, y: 1.55, score: 0.35 },
      { label: "West Ham", x: 1.15, y: 1.75, score: 0.22 },
      { label: "Wolves", x: 0.95, y: 1.8, score: 0.12 },
      { label: "Burnley", x: 0.85, y: 1.95, score: 0.05 },
    ],
    footnote: "xG: Understat · illustrative demo data",
  },
  shot_map: {
    player: "Cole Palmer",
